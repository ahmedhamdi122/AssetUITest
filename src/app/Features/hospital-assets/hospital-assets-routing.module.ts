...
//   { path: 'print-qrs', component: PrintQrListComponent, data: { breadcrumb: 'Asset.Qr' } },
...
//   { path: 'lsthorizontal', component: ListhorizontalComponent, data: { breadcrumb: 'Asset.HospitalAssets' } },
